...
<body>
    <div class="form-container">
        <h1>Thêm Túi Xách Mới</h1>
        <form method="POST" action="{{ route('bags.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="field">
            ...
            <button type="submit" class="btn">Thêm Túi Xách</button>
        </form>
        <div class="back-link">
